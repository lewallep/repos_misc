...
// This code is onlyslightly modified to work with my html layouts in this phone app.
// The code was acquired from Microsoft code samples: https://code.msdn.microsoft.com/windowsapps/HttpClient-sample-55700664
...
var Helpers = {
    ...
    scenarioStarted: function () {
        document.getElementById("getStartButton").disabled = true;
        document.getElementById("getCancelButton").disabled = false;
        var outputField = document.getElementById("getOutput");
        if (outputField) {
            outputField.value = "";
        }
    },
    ...
    scenarioCompleted: function () {
        document.getElementById("getStartButton").disabled = false;
        document.getElementById("getCancelButton").disabled = true;
    },
