...
define('BUSINESS_TABLE', 'crrd_businesses');
define('CAT_TABLE', 'crrd_categories');
define('BUSINESS_CAT_TABLE', 'crrd_business_categories');
define('USER_TABLE', 'users');

$site_root = 'http://'.$_SERVER['HTTP_HOST'].preg_replace('/\/[^\/]*\.php.*/', '', $_SERVER['REQUEST_URI']);
...
define('BING_MAPS_KEY', 'AhTTNOioICXvPRPUdr0_NAYWj64MuGK2msfRendz_fL9B1U6LGDymy2OhbGj7vhA');
...
define('DB_HOST', 'mysql.eecs.oregonstate.edu');
define('DB_NAME', 'cs419-g3');
define('DB_USER', 'cs419-g3');
define('DB_PASS', 'HZ4wbtryHMGKhDZU');
 ...
 */
define("EMAIL_PASSWORDRESET_URL", SITE_ROOT."password_reset.php");
 ...
 */
define("EMAIL_VERIFICATION_URL", SITE_ROOT."register.php");
